...
public class ColourModes extends JFrame implements ActionListener, MouseListener
{
    ...
    public void actionPerformed(ActionEvent aevt)
    {
        ...
        if (selected.equals(normal)){
            ...
            this.dispose();
            new Kingdom(this.playerMode,this.humanPlayers, "normal", this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour, false);
         ...
         if (selected.equals(deficiency)){
            ...
            this.dispose();
            new Kingdom(this.playerMode,this.humanPlayers, "deficiencyMode", this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour, false);
