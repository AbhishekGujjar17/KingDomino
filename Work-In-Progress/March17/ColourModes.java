...
public class ColourModes extends JFrame implements ActionListener, MouseListener
{
    ...
    public ColourModes(int playerMode,int humanPlayers, int computerPlayers, String playerOne, String playerTwo, String playerThree, String playerFour)
    {
    ...
    public void actionPerformed(ActionEvent aevt)
    {
        ...
        if (selected.equals(normal)){
            ...
            this.dispose();
            GameScreen game = new GameScreen(this.playerMode,this.humanPlayers,this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour);
