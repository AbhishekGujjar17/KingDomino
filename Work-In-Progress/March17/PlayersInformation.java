...
public class PlayersInformation extends JFrame implements ActionListener, MouseListener
{
    ...
    //getter methods to get the names of the players
    ...
    public void actionPerformed(ActionEvent aevt)
    {
        ...
        if (selected.equals(back)){
            ...
            if (this.computerPlayers==true){
                this.dispose();
                ComputerDifficulty computerDifficultyMode = new ComputerDifficulty(this.playerMode,this.humanPlayers,this.computerPlayers,playerOneName.getText(),playerTwoName.getText(),null,null);
                
            }
            
            else{
                this.dispose();
                ColourModes displayingColourModes = new ColourModes(this.playerMode,this.humanPlayers,1,playerOneName.getText(),playerTwoName.getText(),null,null);
            }
            
            
        }
        
        else if ((selected.equals(submitFour)) && (!playerOneName.getText().isEmpty()) && (!playerTwoName.getText().isEmpty())
        && (!playerThreeName.getText().isEmpty()) && (!playerFourName.getText().isEmpty())){
            
            if (this.computerPlayers){
                this.dispose();
                ComputerDifficulty computerDifficultyMode = new ComputerDifficulty(this.playerMode,this.humanPlayers,this.computerPlayers,playerOneName.getText(),playerTwoName.getText(),playerThreeName.getText(),playerFourName.getText());
                
            }
            
            else{
                this.dispose();
                ColourModes displayingColourModes = new ColourModes(this.playerMode,this.humanPlayers,2,playerOneName.getText(),playerTwoName.getText(),playerThreeName.getText(),playerFourName.getText());
            }
