...
class TileStack extends JPanel implements MouseListener {
    ...
    public void setSlotTile(int tileNumber, int slotNumber){
        ...
        switch (slotNumber) {
            case 1 -> {
                slot1.setTile(new DominoTile(tileNumber, 1));
            }
            case 2 -> {
                slot2.setTile(new DominoTile(tileNumber, 1));
            }
            case 3 -> {
                slot3.setTile(new DominoTile(tileNumber, 1));
            }
            case 4 -> {
                slot4.setTile(new DominoTile(tileNumber, 1));
            }
        }
    }
