...
public class PlayerTerritory extends JPanel implements ActionListener, MouseListener
{
    ...
    private final TerritoryState territoryState;
    private String ColourMode;
    
    public PlayerTerritory(String playerName, Color playerColour, boolean computerPlayer, GameScreen parent, String ColourMode)
    {
        ...
        if (this.ColourMode.equals("deficiencyMode")) {
