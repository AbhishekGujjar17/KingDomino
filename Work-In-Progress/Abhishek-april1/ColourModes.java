...
public class ColourModes extends JFrame implements ActionListener, MouseListener
{
    ...
    public void actionPerformed(ActionEvent aevt)
    {
        ...
        if (selected.equals(normal)){
            ...
            this.dispose();
            new GameScreen(this.playerMode,this.humanPlayers, "normal", this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour);
         ...
         if (selected.equals(deficiency)){
            ...
            this.dispose();
            new GameScreen(this.playerMode,this.humanPlayers, "deficiencyMode", this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour);
