...
public class GameWindow extends JFrame 
{
    ...
    public GameWindow() throws IOException {
        ...
        kingdom.setSize(new Dimension(100, 0));
        kingdom.setBackground(lightBlue);
        kingdom.setBorder(BorderFactory. createLineBorder(Color. blue));
        ...
        kingdomMap.setLayout(new GridBagLayout());
        kingdomMap.setPreferredSize(new Dimension(500, 500));
        ...
        for ( int x = 0; x < columns; x ++)
        {
            for ( int y = 0; y < rows; y ++)
            {
                ...
                kingdomMap.add(gridSquares[x][y], gbc);
            }
        }

        // TODO: This is only to show how the tiles will appear
        //  it will be removed once people working on this have understood how it works.
        kingdomMap.remove(gridSquares[0][0]);
        kingdomMap.remove(gridSquares[1][0]);
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 2;
        kingdomMap.add(new DominoTile(1).front, gbc);
        //kingdomMap.add(new DominoTile("Domino1.png", "1.png"));
