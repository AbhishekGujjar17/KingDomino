    ...
    
    {
          ...
          //try{  
             ...
             {   
               ...
               //JOptionPane.showMessageDialog(this,playerName + "now you can select a Domino from Current Domino Tiles where you want to place your King Meeple","WELCOME TO GAME",JOptionPane.PLAIN_MESSAGE);
             }
            //}
          /**catch(IOException ex){System.out.println("hello");}**/
            //KingdomLayout square = (KingdomLayout) selected;
