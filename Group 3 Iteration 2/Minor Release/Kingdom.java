...
public class Kingdom extends JFrame implements ActionListener
{
    ...
    public Kingdom(int playerMode,int humanPlayers, boolean computerPlayers, String playerOne, String playerTwo, String playerThree, String playerFour)
        ...
        if (playerMode==2){
            ...
            map1= new PlayerTerritory(playerOne, Color.red);
            map2= new PlayerTerritory(playerTwo, Color.blue);
            maps.add(map1);
            maps.add(map2);
        }
            ...
            map1= new PlayerTerritory(playerOne, Color.red);
            map2= new PlayerTerritory(playerTwo, Color.blue);
            map3= new PlayerTerritory(playerThree, Color.darkGray);
            map4= new PlayerTerritory(playerFour, Color.magenta);
            maps.add(map1);
            maps.add(map2);
            maps.add(map3);
            maps.add(map4);
