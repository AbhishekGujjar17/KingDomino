    ...
    public void actionPerformed(ActionEvent aevt)
    {
        ...
        if (selected.equals(normal)){
         ...
         if (selected.equals(deficiency)){
            ...
            this.dispose();
            KingdomColorBlind game = new KingdomColorBlind(this.playerMode,this.humanPlayers,this.computerPlayers,this.playerOne,this.playerTwo, this.playerThree, this.playerFour);
